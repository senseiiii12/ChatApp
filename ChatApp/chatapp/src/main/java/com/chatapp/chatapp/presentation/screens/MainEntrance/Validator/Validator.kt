package com.chatapp.chatapp.presentation.screens.MainEntrance.Validator
...
object Validator {
    ...
    fun validateEmail(email: String): EmailValidationError? {
        return when {
            ...
            !android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches() -> EmailValidationError.INVALID_EMAIL
            else -> null
        }
    }
